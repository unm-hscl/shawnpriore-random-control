...
legend([p1,p2,p3,p4], ['Proposed Method', "Scenario", 'Line of Sight', 'Target Set'], ...
...
plot(Ex_x_scen(1:6:end),Ex_x_scen(2:6:end), '-sk','MarkerSize',15);
...
plot(Ex_x_scen(1:6:end), Ex_x_scen(3:6:end), '-sk','MarkerSize',15);
patch([0; 10; 10], [0; -5; 5], 'b', 'FaceAlpha', 0.1);
patch([0; 2; 2; 0], [-0.5; -0.5; 0.5; 0.5], 'g', 'FaceAlpha', 0.1);
xlabel('x');
ylabel('z');
